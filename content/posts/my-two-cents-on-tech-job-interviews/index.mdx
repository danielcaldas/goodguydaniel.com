...
- **SYAO** - Yes, study your ass off. Practice and read a lot. Here a few good resources to get you started (some of them are very JS and front-end oriented sorry for that):
  - <a
...
- **Make sure not to waste too much time on the technical tasks**.
