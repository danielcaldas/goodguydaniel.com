...
- You want to show off that beautiful loading animation you've been working all day.
...
Jump over to the Chrome store and <a href="https://chrome.google.com/webstore/detail/tweak/feahianecghpnipmhphmfgmpdodhcapi" target="_blank" title="tweak mock HTTP requests on chrome store">install the tweak browser extension</a>.
