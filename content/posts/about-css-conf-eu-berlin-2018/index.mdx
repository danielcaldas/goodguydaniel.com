...
- <a
  ...
  </a> 🌟 - changes you make in the CSS code styles will be saved locally on your computer.
...
- <a href="http://razvan.is/speaking/cssconfeu-2018/#/26" target="_blank" title="safari css gradient editor">
...
<GIF name="css-variables-demo" alt="using CSS custom properties to color geometric shapes" />
<Caption gif={true} />
...
<Caption source={"https://caniuse.com/#feat=css-variables"} text={"This screenshot is from June 2018."} />
