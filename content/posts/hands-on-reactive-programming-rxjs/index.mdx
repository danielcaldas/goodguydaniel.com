...
- [Let's build something!](#lets-build-something)
  ...
  - [Level 3 - Merging streams into one stream](#level-3---merging-streams-into-one-stream)
    ...
    - [About the coding style in the solutions](#about-the-coding-style-in-the-solutions)
...
At the time of this writing, I feel overwhelmed by the tremendous amount of operators offered by RxJS, its API is considerably large. We could further simplify the above implementation with the operator `mapTo`.
...
###### About the coding style in the solutions
