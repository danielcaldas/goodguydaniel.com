...
<Caption text={() => <p>TODO: FOLLOW WITH A GIF WITH a console.log of the DOM events being logged</p>} />

**What do you get if you subscribe to `catAtParty$`?**

**TODO: FOLLOW WITH A GIF WITH a console.log of the DOM events being logged**
