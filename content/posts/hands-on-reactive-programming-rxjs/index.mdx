...
- If at each drag, the cat is dragged for longer than 5 seconds you lose.
...
<Caption
  text={(a) => (
    <p>
      Our stream gets cancelled after the value <b>3</b> is published. The first <b>dragend</b> event causes the{" "}
      <b>countdownRunning$</b> to stop emitting values.
    </p>
  )}
/>
