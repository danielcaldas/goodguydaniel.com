...
- [Reactive Programming](#reactive-programming)
  ...
  - [Properties of Observables](#properties-of-observables)
...
- Design Patterns: Elements of Reusable Object-Oriented Software (**TODO: LINK**)
...
I leave here a short summary of the properties of Observables (streams). Maybe now some of them don't make sense now, but they will, once you have some hands-on experience with some reactive library (jump to the next article to get some practice). **Observables in a reactive library are**:

- **Primitive type** with 0 to many values, pushed over any amount of time (yes, mentioned quite a few times already).
...
- **Lazy. Observables don't do anything until you subscribe.** Promises are eager. That's why we often wrap them in a function, making them lazy, so they only execute when we call them.
