...
There are **3 very important aspects about Observables** in reactive programming. Maybe now some of them don't make sense now, but they will, once you have some hands-on experience with some reactive library. **Observables are**:
